...
namespace DDDSample1.Infrastructure.Shared{
    ...
    public class StronglyEntityIdValueConverterSelector : ValueConverterSelector{
        ...
        private readonly ConcurrentDictionary<(Type ModelClrType, Type ProviderClrType), ValueConverterInfo> _converters = new ConcurrentDictionary<(Type ModelClrType, Type ProviderClrType), ValueConverterInfo>();
